Fix the Android project at /tmp/fizzy-home-place so the failing quality-fix-1 step passes.
...
Recent failure log:
```text
=== QUALITY CHECK: /tmp/fizzy-home-place ===
...
WARN: Only 1 commit(s) — final implementation commit may not exist yet
  ...
  OK: icon.png (209571B, 512x512, rounded opaque canvas, transparent corners)
FAIL: Manifest references .SkeletonApplication but class not found — CRASH
  OK: HomeScreen.kt: 163 lines
